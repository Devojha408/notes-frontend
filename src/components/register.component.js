...
const Signup = () => {
  ...
  const handleSignup = async (e) => {
    e.preventDefault();
    try {
      await AuthService.register(firstName, lastName, email, password, number).then(
        (response) => {
    ...
    <div>
      <form onSubmit={handleSignup}>
        ...
        <div className="form-group">
          ...
          <Input type="text" name="number" id="number" placeholder="Enter Mobile Number" onChange={(e) => setNumber(e.target.value)} />
        </div>
